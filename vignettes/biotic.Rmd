---
title: "package 'biotic'"
author: "Dr Rob Briers"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Vignette for 'biotic' package}
...
```
The current development version can be obtained from GitHub. The homepage of the package is [https://github.com/robbriers/biotic](https://github.com/robbriers/biotic). In order to install the development version, you need to first install the 'devtools' package.
```{r, eval=FALSE}
